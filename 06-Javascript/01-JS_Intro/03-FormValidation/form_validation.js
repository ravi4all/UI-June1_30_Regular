...
function init(){
    ...
    document.getElementById("box_1").addEventListener("blur",validate)
    document.getElementById("box_2").addEventListener("keyup",check_strength)
    document.getElementById("box_3").addEventListener("keyup",conf_pwd)
}
